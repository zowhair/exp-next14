  ...
  return (
    <html lang="en">
        <Head>
          ...
          <meta name="Expedition Asia Trek And Tours" content="Expedition Asia Trek and Tours is Gilgit Baltistan based tour operating company. We arrange expeditions to K2, masherbrum, gasherbrum,. Skardu, Gilgit Baltistan. " key="" />
          <meta property="og:title" content="Skardu Gilgit Expedition K2" />
          <meta
            property="og:description"
            content="Skardu Gilgit Expedition K2 Trekking Tours GB"
          />
          <meta
            property="og:image"
            content="/images/logos/logo-top.png"
          />
          <link rel="shortcut icon" href="/images/logos/logo-top.png" />
        </Head>
